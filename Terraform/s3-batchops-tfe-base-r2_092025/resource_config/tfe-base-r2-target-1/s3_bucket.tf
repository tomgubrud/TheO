...
module "dst_kms_key" {
  ...
  key_label          = "tfe-base-r2-target-1-kms"
  policy             = module.dst_base_kms_policy.policy
...
module "target_bucket" {
  ...
  bucket_name              = "tfe-base-r2-target-1"
  kms_key_arn              = module.dst_kms_key.key_arn
